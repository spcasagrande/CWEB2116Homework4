namespace Homework4CWEB2116
{
	partial class InsertRecord
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Location = new System.Drawing.Point(389, 25);
			this.label5.Name = "label5";
			this.label5.Size = new System.Drawing.Size(350, 54);
			this.label5.TabIndex = 24;
			this.label5.Text = "Insert New Tool";
			// 
			// label4
			// 
